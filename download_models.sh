cd models
wget https://github.com/ml-inory/melotts.axera/releases/download/v1.0/encoder-zh.onnx
wget https://github.com/ml-inory/melotts.axera/releases/download/v1.0/encoder-jp.onnx
wget https://github.com/ml-inory/melotts.axera/releases/download/v1.0/encoder-en.onnx
